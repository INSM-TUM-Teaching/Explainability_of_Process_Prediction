...
@app.post("/api/datasets/{dataset_id}/splits/generate", response_model=DatasetUploadResponse)
...
@app.post("/api/datasets/{dataset_id}/splits/upload", response_model=DatasetUploadResponse)
...
@app.post("/api/datasets/splits/upload", response_model=DatasetUploadResponse)
...
@app.get("/api/datasets/{dataset_id}/splits/{split_name}")
...
@app.get("/api/datasets/{dataset_id}/preprocessed")
